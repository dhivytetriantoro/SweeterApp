 // {% if msg %}
        ...
        // untuk mengatur on dan off class CSS pada suatu elemen
        ...
        // untuk mengecek value dan juga memerika apakah identitas user masih valid atau tidak 
...
// mengambil data list seluruh post dan menampilkannya di layar
function get_posts() {
    $('#post-box').empty();
    $.ajax({
        type: 'GET',
